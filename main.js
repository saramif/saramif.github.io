...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Welcome to terminal version of my resume \nTo see my experience, accomplishments, and skills use the format:\n cat [keyword].txt \n Keywords: experience, about-me, volunteering, awards, certificates, contact, LinkedIn, one-day \nNow in order to get started, feel free to either execute the 'help' command or use the more user-friendly colored side menu at your left.\nIn order to skip text rolling, double click/touch anywhere.",
